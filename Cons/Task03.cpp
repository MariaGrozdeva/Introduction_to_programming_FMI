...
void printBitstring(const bool* bitstring, size_t size)
{
...
void generateAllBitstringsWithEqualSum(unsigned int start, unsigned int end, int diff, bool* bitstring, size_t size)
{
