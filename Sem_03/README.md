...
***Пример 5:***  
Въвежда се цяло положително число. Да се напише програма, която отпечатва разбиването му на прости множители, сортирани низходящо.  
*Вход: 50, Изход: 5^2 2^1*  
Решение - example5_prime.cpp  
